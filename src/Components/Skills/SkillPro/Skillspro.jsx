...
// import Aboutme from "./FrontendSvg/FrontEndSvg";
  ...
  return (
    <section className="Skillpro">
      <div className=" p-4 ">
        ...
        <h5 className="Skillpro-navbar-links container text-center mb-3" ref={(el) => (cardsRef.current[0] = el)}>Client-Side Development</h5>
...
<h5 className="Skillpro-navbar-links container text-center mb-3" ref={(el) => (cardsRef.current[0] = el)}>Server-Side Development</h5>
  ...
  <div className="card Skillpro-svg-box mx-auto text-center p-3 h-100">
    {isMediumScreen ? (
      ...
      <BackendSvg />
                ...
                <div className="col-md-8 d-flex flex-column gap-3"   ref={(el) => (cardsRef.current[2] = el)}>
                  <div className="card Skillpro-box text-center p-3 flex-fill">
                    <h5>
                      <b>Languages</b>
                    </h5>
                ...
                <div className="col-md-12 mb-3" ref={(el) => (cardsRef.current[3] = el)}>
                  <div className="card Skillpro-box text-center p-3 h-100">
                    <h5>
                      <b>Frameworks</b>
                    </h5>
...
<h5 className="Skillpro-navbar-links container text-center mb-3" ref={(el) => (cardsRef.current[0] = el)}>Additional Competencies</h5>
            ...
            <div className="container">
              <div className="row g-3 align-items-stretch">
                ...
                <div className="col-md-6"  ref={(el) => (cardsRef.current[1] = el)}>
                  <div className="card Skillpro-box text-center p-3 h-100">
                    <h5>
                    ...
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <span style={{ color: "#1b29c0ff" }}>VS Code:</span><br/>
                ...
                {/* Right column */}
                <div className="col-md-6 d-flex flex-column gap-3"  ref={(el) => (cardsRef.current[2] = el)}>
                  <div className="card Skillpro-box text-center p-3 flex-fill">
                    <h5>
                      <b>API & Authentication</b>
                    </h5>
                    <p className="skill-items">
                      <span><MdApi size={20}/> API Integration</span>
                      <span><SiJsonwebtokens size={20} />RESTful API Consumption</span>
                      <span><AiOutlineLoading3Quarters size={20}/>JWT-Based Authentication</span>
                      <span><SiPostman size={20}/>
